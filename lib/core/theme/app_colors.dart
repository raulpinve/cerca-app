...
class AppColors extends ThemeExtension<AppColors> {
  ...
  static const warm = AppColors(
    ...
    border: Color(0xFFEFE6D8),
    indicator: Color(0xFFF3E4D4),
    selected: Color(0xFFB5673A),
    unselected: Color(0xFFB0A283),
    badge: Color(0xFFD9755C),
    textPrimary: Color(0xFF3A3226),
    textSecondary: Color(0xFFA0906F),
  );
